set -gx CONDA_EXE (cygpath "F:\My Personals\MedicalChatbot\miniconda\Scripts\conda.exe");
set -gx _CONDA_EXE (cygpath "F:\My Personals\MedicalChatbot\miniconda\Scripts\conda.exe");
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE (cygpath "F:\My Personals\MedicalChatbot\miniconda\python.exe");
set -gx _CONDA_ROOT (cygpath "F:\My Personals\MedicalChatbot\miniconda");
